  ...
  return (
    <div className="relative inline-block">
      ...
      <button
        ...
        className="px-3 py-1 rounded-xl bg-white hover:bg-slate-50 border border-[#E1EEF9] text-xs font-semibold font-body text-slate-700 shadow-[0_2px_8px_rgba(30,95,191,0.06)] flex items-center gap-1.5 transition-colors cursor-pointer select-none"
        title="Jump to Port"
      >
        <MapPin className="w-3.5 h-3.5 text-sky-600 shrink-0" />
        <span className="truncate max-w-[130px] sm:max-w-none text-xs font-semibold font-body text-slate-700">
      ...
      {isOpen &&
        ...
        createPortal(
          <div
            ...
            className="bg-white border border-[#E1EEF9] rounded-2xl shadow-[0_10px_30px_rgba(30,95,191,0.15)] p-2.5 text-slate-800 animate-fadeIn font-body"
          ...
          >
            ...
            <div className="flex items-center justify-between pb-2 border-b border-slate-100 px-1 mb-2">
              <div className="flex items-center gap-1.5">
                ...
                <span className="heading-section text-xs font-bold text-[#0B2545]">Major Indian Ports</span>
              </div>
            ...
            <div className="relative mb-2">
              ...
              <input
                ...
                className="w-full pl-8 pr-7 py-1.5 bg-[#F8FBFE] border border-[#E1EEF9] rounded-xl text-xs font-body text-slate-800 placeholder-slate-400 focus:outline-none focus:border-[#1E5FBF] focus:bg-white transition-colors"
              />
              {searchQuery && (
                <button
                  type="button"
            ...
            <div
              ...
              className="overflow-y-auto space-y-1 pr-1 custom-port-scrollbar font-body"
            ...
            >
                ...
                return (
                  ...
                  >
                    ...
                    <div className="min-w-0 flex-1">
                      <div className="text-xs font-bold font-body truncate">
                        {port.name}
                      </div>
                      <div className="text-[10px] text-slate-500 font-body flex items-center gap-1 mt-0.5">
              ...
              {filteredPorts.length === 0 && (
                <div className="text-center py-6 text-xs text-slate-400 font-body">
